...
@section('content_header')
    <h4>Listado de alumnos del Periodo Agosto-Diciembre</h4>
@stop
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-start">
                <form class="d-flex" role="search" action="{{route('lista.alumnoP2')}}" method="GET">

                    <input name="anio" class="form-control me-2" type="search" placeholder="Año" aria-label="Search" value="{{$anio}}" required>
                    <button class="btn btn-success" type="submit">Buscar</button>
                    <a class="btn btn-warning" id="limpiar" href="{{route('lista.alumnoP2')}}">Limpiar</a>
                  </form>
            </div>
