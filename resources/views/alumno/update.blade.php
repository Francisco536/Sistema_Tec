                ...
                <div class="card-body">
                    <form method="POST" name="updAlumno" id="updAlumno" action="{{ route('update.alumno', $alumno->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="periodo" name="periodo" value="{{ old('periodo') }}"class="form-control select2" style="width: 100%;" value="{{ $alumno->periodo }}" required>
...
//primeras letras mayusculas
    function capitalize(str){
        ...
        var aluact = document.getElementById('updAlumno');
        aluact.addEventListener("submit", (e) => {
